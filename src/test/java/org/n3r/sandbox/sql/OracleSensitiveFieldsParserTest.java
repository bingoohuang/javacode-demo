...
public class OracleSensitiveFieldsParserTest {
    ...
    public void testInsertSelect() {
        OracleSensitiveFieldsParser parser = OracleSensitiveFieldsParser.parse(sql,
                securetFields);
    ...
    public void testInsertAll() {
        OracleSensitiveFieldsParser parser = OracleSensitiveFieldsParser.parse(insertAllSql,
                securetFields);
    ...
    public void testSelect() {
        OracleSensitiveFieldsParser parser = OracleSensitiveFieldsParser.parse(selectSql,
                securetFields);
    ...
    public void testUnion() {
        OracleSensitiveFieldsParser parser = OracleSensitiveFieldsParser.parse(unionSql,
    ...
    public void testFunctionSql() {
        OracleSensitiveFieldsParser parser = OracleSensitiveFieldsParser.parse(fnSql,
    ...
    public void testPageSql() {
        OracleSensitiveFieldsParser parser = OracleSensitiveFieldsParser.parse(pageSql,
    ...
    public void testUpdateSetQuery() {
        OracleSensitiveFieldsParser parser = OracleSensitiveFieldsParser.parse(updateSetQuery,
    ...
    public void testQuery1() {
        ...
        OracleSensitiveFieldsParser visitorAdapter = OracleSensitiveFieldsParser.parse(sql, securetFieldsConfig);
        ...
        visitorAdapter = OracleSensitiveFieldsParser.parse(sql, securetFieldsConfig);
    ...
    public void testOrderSelect() {
        ...
        OracleSensitiveFieldsParser visitorAdapter = OracleSensitiveFieldsParser
                .parse(orderSql, securetFieldsConfig);
    ...
    public void testFuncSql() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(funcSql, Sets.newHashSet("TF_B_BESPEAK_REG.PCARD_CODE"));
    ...
    public void testSubQueryIn() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(subQuery, Sets.newHashSet("TF_B_ORDER_POST.POST_ADDR", "TD_B_COMMPARA.PARA_CODE2",
    ...
    public void testMyPage() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(myPageSql, Sets.newHashSet("TABLE.B"));
    ...
    public void testStartSql() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(starSql, Sets.newHashSet("TAB.B"));
    ...
    public void testMergeSql() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(mergeSql, Sets.newHashSet("TF_B_TAOBAO_NETIN.PSPT_NO"));
    ...
    public void testZjSql() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(zjSql, Sets.newHashSet("TF_B_BESPEAK_INFO.PSPT_NO"));
    ...
    public void testWhcIntervalAliasSql() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(whcSql, Sets.newHashSet("TF_B_ORDER_POST.POST_ADDR"));
    ...
    public void testPsptNoSql() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(psptNoSql, Sets.newHashSet("TF_B_ORDER_NETIN.PSPT_NO"));
    ...
    public void testMenuSql() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(menuSql, Sets.newHashSet("TF_B_ORDER_NETIN.PSPT_NO"));
    ...
    public void testAlias() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(aliasSql, Sets.newHashSet("TF_B_BESPEAK_INFO.LINK_ADDR", "TF_B_BESPEAK_INFO.PSPT_NO"));
    ...
    public void testAlias2() throws Exception {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(aliasSql2, Sets.newHashSet("TF_B_BESPEAK_INFO.LINK_ADDR", "TF_B_BESPEAK_INFO.PSPT_NO"));
    ...
    public void testPartition() {
        OracleSensitiveFieldsParser visitor = OracleSensitiveFieldsParser
                .parse(partitionSql, Sets.newHashSet("TF_B_BESPEAK_INFO.LINK_ADDR", "TF_B_BESPEAK_INFO.PSPT_NO"));
