...
public class OracleSensitiveFieldsParser {
    ...
    public static OracleSensitiveFieldsParser parse(String sql, Set<String> securetFields) {
    ...
    // temporarily replace all trim function for the bug of current sql parser.
    // this will be removed when the sql parse upgraded and fixed the bug.
    static Pattern trimPattern = Pattern.compile("\\btrim\\b", Pattern.CASE_INSENSITIVE);
